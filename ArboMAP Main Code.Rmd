...
humandatafile <- ".\\human case data\\simulated michigan human case data.csv"
...
weekinquestion <- as.Date("2018-07-15", "%Y-%m-%d")
...
mosqfile <- ".\\mosquito data\\simulated michigan mosquito data.csv"
